...
--
-- Hôte : 127.0.0.1
-- Généré le : jeu. 28 déc. 2023 à 15:11
...
(1, 'Dodomu', 'Mia Tozerski est une artiste peintre ukrainienne réfugiée de la guerre. Sur cette oeuvre, Dodomu (\'domicile\' en ukrainien), elle nous montre la tristesse du peuple ukrainien qu\'elle partage, ayant elle-même dû quitter son foyer. L\'œuvre évoque le drapeau liquéfié d\'une Ukraine en souffrance, pleurant la mort de ses compatriotes. Ce travail chargé d\'émotion est le symbole d\'un événement qui marquera l\'Histoire. Cette peinture à l\'acrylique rayonne grâce à son fond lisse et ses mélanges de couleurs éclatantes.', 'Mia Tozerski', 'img/clark-van-der-beken.png'),
...
(16, 'Salamèche', 'Salamèche est un personnage fictif de la célébre franchise  Pokémon créée par Satoshi Tajiri en 1996, présente en particulier en jeu vidéo, dans des séries éditées par Nintendo. Selon les statistiques de Nintendo en 2010, les jeux Pokémon se sont vendus à environ 250 millions d’unités.', 'Enzo', 'https://cdn.pixabay.com/photo/2021/12/26/17/31/pokemon-6895600_1280.png');
